...
# =========================== PARAMETERS =================================
SENSOR_ID   = "r_hand"
MAC_ADDR    = "EE:1B:72:FA:BF:E8"                       # MAC MetaMotionRL
MODEL_PATH  = "./cnn_lstm_fold1.pth"                    # Trained model (input_dim=6 for acc+gyro)
SCALER_PATH = "./scaler_model_ag_right_hand.pkl"        # Scaler joblib.dump() 6 columns [ax,ay,az,gx,gy,gz]
K_CLASSES   = 6                                         # Number of classes
WINDOW_SIZE = 50                                        # 50 samples (~1s a 50Hz)
TARGET_HZ   = 50                                        # Frequency of inference/publication
CONNECT_RETRIES = 8
TOPIC_PROBS = "har/probs/right_hand"                     # ROS topic to publish
TOPIC_QUAT  = "har/imu_right_hand"                       # ROS topic for publishing quaternions
