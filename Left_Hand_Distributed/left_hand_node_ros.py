...
# left_hand_node_ros.py — Local node (l_hand) with QUATERNION → probs → ROS1 and GUI
...
# =========================== PARAMETERS =================================
SENSOR_ID   = "l_hand"
MAC_ADDR    = "EC:57:2E:32:05:52"                       # MAC MetaMotionRL
MODEL_PATH  = "./cnn_lstm_fold1.pth"                    # Trained model (input_dim=4 for quat)
SCALER_PATH = "./scaler_model_q_left_hand.pkl"          # Scaler joblib.dump() 4 columns [w,x,y,z]
K_CLASSES   = 6                                         # Number of classes
WINDOW_SIZE = 50                                        # 50 muestras (~1s a 50Hz)
TARGET_HZ   = 50                                        # Frequency of inference/publication
CONNECT_RETRIES = 8
TOPIC_PROBS = "har/probs/left_hand"                     # ROS topic to publish
TOPIC_QUAT  = "har/imu_left_hand"                       # ROS topic for publishing quaternions
