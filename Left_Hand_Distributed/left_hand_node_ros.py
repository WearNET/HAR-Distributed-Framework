# left_hand_node_ros.py — Local node (l_hand) con QUATERNION → probs → ROS1
...
class LHandNode:
    def __init__(self):
        ...
        # ROS Publisher
        self.pub = rospy.Publisher("har/probs/left_hand", Probs, queue_size=10)
        self.seq = 0
...
if __name__ == "__main__":
    ...
    rospy.init_node("l_hand_node", anonymous=False)
    node = LHandNode()
    try:
